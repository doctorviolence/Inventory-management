...
public class Vendor implements Serializable {
    ...
    @OneToMany(targetEntity = Catalog.class, cascade = CascadeType.ALL, mappedBy = "vendor", fetch=FetchType.LAZY)
    ...
    public String toString() {
        return "Vendor ID: " + vendorId + " Vendor Name: " + vendorName + " Address: " + address +
                " Phone: " + phone + " Website: " + website + " E-mail: " + email;
    }
